...
class B2PairCallback
 {
	...
	// ~B2PairCallback() {}
	// This returns the new pair user data.
	public  function PairAdded(proxyUserData1:Dynamic, proxyUserData2:Dynamic):Dynamic{return null;}
	...
	public  function PairRemoved(proxyUserData1:Dynamic, proxyUserData2:Dynamic, pairUserData:Dynamic) : Void{}
}
...
class MultiMultiMapBuilder<K, V>
{
	public function new (keyType :ValueType)
	{
		_keyType = keyType;
		_keyVals = new Array<Array<Dynamic>>();
	}
	 ...
	 *
	 * @return this MultiMapBuilder, for chaining.
	 */
	public function makeSorted (?comp :K->K->Int = null) :MultiMapBuilder<K, V>
	{
		_sorted = true;
		_comp = comp;
		return this;
	 ...
	 * @return this MultiMapBuilder, for chaining.
	 */
	// public function makeWeakValues () :MultiMapBuilder<K, V>
	// {
	//	 _weakValues = true;
	//	 return this;
	// }
	 ...
	 * @return this MultiMapBuilder, for chaining.
	 */
	public function makeLR (maxSize :Int, ?accessOrder :Bool = true) :MultiMapBuilder<K, V>
	{
		_maxSizeLR = maxSize;
	 ...
	 * @return this MultiMapBuilder, for chaining.
	 */
	public function makeExpiring (createExpiringMapCallback :Map<K, V>->Map<K, V>) :MultiMapBuilder<K, V>
	{
	 ...
	 */
	public function makeImmutable () :MultiMapBuilder<K, V>
	{
		_immutable = true;
		return this;
	}
	 ...
	 */
	public function makeComputing (computer :K->V) :MultiMapBuilder<K, V>
	{
		_computer = computer;
		return this;
	}
	 ...
	 */
	public function setDefaultValue (value :V) :MultiMapBuilder<K, V>
	{
		_defaultValue = value;
		return this;
	}
	 ...
	 */
	public function set (key :K, value :V) :MultiMapBuilder<K, V>
	{
		_keyVals.push(key);
		_keyVals.push(value);
		return this;
	 ...
	 */
	public function setAll (other :Map<K, V>) :MultiMapBuilder<K, V>
	{
		var selfref = this;

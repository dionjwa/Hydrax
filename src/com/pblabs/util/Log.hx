...
class Log
 {
     ...
     */
    static function getLevel (module :String) :Int
    {
    ...
    public static function customTraceFlash (v : Dynamic, ?pos : haxe.PosInfos ) :Void
    {
        ...
        var pstr = if( pos == null ) "" else pos.fileName+":"+pos.lineNumber + ": ";
        var line = pstr +__string_rec(v,"");
        lines.push(line);
    ...
    public static function setupPBGameLog () :Void
    {
        ...
        com.pblabs.engine.debug.Log.debug = debugStatic;
        com.pblabs.engine.debug.Log.info = infoStatic;

...
class SerialTask extends TaskContainer 
{
		...
		?subtask5:IEntityTask, ?subtask6:IEntityTask, ?subtask7:IEntityTask)
	{
		...
		if (subtask5 != null) {
			subtasks.push(subtask5);
		}
		if (subtask6 != null) {
			subtasks.push(subtask6);
		}
		if (subtask7 != null) {
			subtasks.push(subtask7);
		}

...
function main (stage) {
	...
	public function new() 
	{
		...
		flash.Lib.onSpaceportReady(function () :Void {
			...
			// var swfresource = new SwfResource("avatar", Source.url("rsrc/avatar.swf"));
			// swfresource.load(function () :Void {
			// 	trace("loaded");
			// 	trace(swfresource.getSymbolNames());
			// 	var cls = swfresource.getSymbol("circle");
			// 	trace('cls=' + Std.string(cls));
			// 	var clip = Type.createInstance(cls, []);
			// 	// var clip = untyped __js__("new cls()");
			// 	trace('clip=' + Std.string(clip));
			// 	flash.Lib.current.stage.addChild(clip);
			// },
			// function (e) :Void {
			// 	trace(e);
			// }
			...
			var libraryLoader = new flash.display.Loader();
			var libraryURL = "rsrc/avatar.swf";
			var libraryURLRequest = new flash.net.URLRequest(libraryURL);
			libraryLoader.load(libraryURLRequest);
			flash.Lib.current.stage.addChild(libraryLoader);
			
			// var pictLdr = new flash.display.Loader();
			// var pictURL = "rsrc/avatar.png";
			// var pictURLReq = new flash.net.URLRequest(pictURL);
			// pictLdr.load(pictURLReq);
			// trace('pictLdr=' + pictLdr);
			// flash.Lib.current.stage.addChild(pictLdr);
